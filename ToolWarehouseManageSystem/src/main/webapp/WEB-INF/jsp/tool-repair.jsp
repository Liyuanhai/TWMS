                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" style="padding-top: 20px;" role="form" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/addRepair">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="tid" placeholder="" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >送修人员： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="sendpeople" placeholder="" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group  col-sm-12">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <input class="form-control date-picker" name="sendtime" type="text" data-date-format="mm-dd-yyyy" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >送修班次： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="shift"  required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">送修班组： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="team" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">送修方式： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="sendmethod" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">维修人员： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="repairpeople" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">送修故障描述： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="sendfaultdescription" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >维修故障描述： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="repairfaultdescription" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">更换备件及处理措施： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="handmeasures" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="remark" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
