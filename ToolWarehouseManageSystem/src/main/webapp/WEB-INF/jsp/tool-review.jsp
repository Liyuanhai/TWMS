    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="javascript:void(0)">工装评审</a>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form id="addReview" class="form-horizontal" style="padding-top: 20px;" role="form" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/addToolReview">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >PCB型号： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="pcbmodel" placeholder="" required="" class=" col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="conclusion" placeholder="" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group  col-sm-12">
                                ...
                                <div class="col-xs-12 col-sm-4">
                                    <input class="form-control date-picker" name="reviewtime" type="text" data-date-format="yyyy-mm-dd" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >编制： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="organization"  required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >会签： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="countersign" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="examine" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >批准： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="approval" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="remarks" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
