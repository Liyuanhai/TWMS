            ...
            <div class="page-content-area">
                ...
                <div class="row" style="padding-top: 10px;">
                    <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div style="padding-bottom: 10px;padding-top: 10px;text-align: center">
                                    ...
                                    <select class="" id="form-field-select-1" style="height: 35px;margin-left: 10px;">
                                        ...
                                        <option value="pname">按工装编号查找
                                        </option>
                                        <option value="pid">按工装型号查找
                                        </option>
                                    </select>
                                ...
                                <div class="table-responsive">
                                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <%--弹窗按钮--%>
                                                <a href="#editTool" role="button" class="btn btn-xs btn-info" data-toggle="modal">
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" role="form">
                                            ...
                                            <div class="form-group" style="padding-top: 10px;padding-left: 120px;">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="pid" placeholder="请输入用户编号" class="col-xs-10 col-sm-7" required=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" style="padding-left: 120px;">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="pname" placeholder="输入用户姓名" class=" col-xs-10 col-sm-7" required=""/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" style="padding-left: 120px;">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="pwd" placeholder="输入用户密码" class="col-xs-10 col-sm-7" required=""/>
                                                </div>
                                            </div>
                        ...
                        <div id="editTool" class="modal fade" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header no-padding">
                                        <div class="table-header">
