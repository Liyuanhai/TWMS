    ...
    <div class="main-content">
        ...
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="javascript:void(0)">版本升级</a>
                </li>
            </ul><!-- /.breadcrumb -->
        </div>
            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" style="padding-top: 20px;" role="form" method="post" action="${pageContext.request.contextPath}/addVersion">
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" > PCB编码：</label>

                                <div class="col-sm-9">
                                    <input type="text" name="pcbid"  required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >PCB旧版本： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="oldversion" required="" class=" col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >升级后PCB版本： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="newversion" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >ICT工装更改情况： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="ictchenge" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >FCT工装更改情况： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="fctchenge" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >ICT工装更改编号： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="ictchengeid" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >FCT工装更改编号： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="fctchengeid" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" >一拖四工装更改编号： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="otfchengeid" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">ICFT工装更改编号： </label>

                                <div class="col-sm-9">
                                    <input type="text" name="icftchengeid" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group  col-sm-12">
                                <label class="col-sm-3 control-label no-padding-right">到货时间： </label>
                                <div class="col-xs-12 col-sm-4">
                                    <input class="form-control date-picker" name="arrivetime" type="text" data-date-format="yyyy-mm-dd" />
                                </div>
                            </div>
                            ...
                            <div class="form-group  col-sm-12">
                                <label class="col-sm-3 control-label no-padding-right">更改日期： </label>
                                <div class="col-xs-12 col-sm-4">
                                    <input class="form-control date-picker" name="chengetime" type="text" data-date-format="yyyy-mm-dd" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" name>完成情况： </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-4" name="completion" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
