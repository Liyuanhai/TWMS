                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" style="padding-top: 20px;" role="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">工装型号： </label>

                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1-1" placeholder="输入工装型号" required="" class=" col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right" for="form-field-2">制作人： </label>

                                <div class="col-sm-9">
                                    <input type="password" id="form-field-2" placeholder="请输入制作人" required="" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
