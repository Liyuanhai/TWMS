            ...
            <div class="page-content-area">
                ...
                <div class="row" style="padding-top: 10px;">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <form id="searchUser" action="${pageContext.request.contextPath}/searchUser" method="post">
                                    ...
                                    <div style="padding-bottom: 10px;padding-top: 10px;text-align: center">
                                        ...
                                        <select name="conditions" style="height: 35px;margin-left: 10px;">
                                            ...
                                            <option value="pName" <c:if test="${conditions=='pName'}">selected="selected"</c:if> >按姓名查找
                                            </option>
                                            <option value="pID" <c:if test="${conditions=='pID'}">selected="selected"</c:if>>按员工编号查找
                                            </option>
                                        </select>
                                ...
                                <div class="table-responsive">
                                        ...
                                        <c:forEach var="users" items="${users}">
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    <%--弹窗按钮--%>
                                                    <a href="#editUser${users.getPid()}" role="button" class="btn btn-xs btn-info" data-toggle="modal"

                                                    >
                                                        <i class="ace-icon fa fa-pencil bigger-120" ></i>
                                                    </a>

                                                    <a href="${pageContext.request.contextPath}/deleteUser?pid=${users.getPid()}" type="button" role="button" class="btn btn-xs btn-danger" onclick="return isDelete()">
                                                        <i class="ace-icon fa fa-trash-o bigger-120"></i>
                                                    </a>
                                                    <div id="editUser${users.getPid()}" class="modal fade" tabindex="-1">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="editUser${users.getPid()}" class="form-horizontal"  role="form" method="post" action="${pageContext.request.contextPath}/editUser">
                                                                        ...
                                                                        <div class="form-group" style="padding-top: 10px;padding-left: 120px;">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                <input type="text" readonly="readonly" name="pid" placeholder="请输入用户编号" class="col-xs-10 col-sm-5" required="" value="${users.getPid()}"/>
                                                                            </div>
                                                                        </div>
                        ...
                        <div id="addUser" class="modal fade" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="userManage" class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/insertUser">
                                            <!-- #section:elements.form -->
                                            <div class="form-group" style="padding-top: 10px;padding-left: 120px;">
                                                <label class="col-sm-3 control-label no-padding-right"> 编号：</label>
...
<script>
    ...
    function importUsers(){
        ...
        if(roleID == 1){
            document.getElementById('userManage').action = "${pageContext.request.contextPath}/importUsers";
            $("#userManage").submit();
        }else{
        ...
        if(roleID == 1){
            ...
            if (checkID.length!=0){
                if (confirm("您确认要删除选中的内容吗？")==false)
                    ...
                    $.ajax({
                        url:'${pageContext.request.contextPath}/delCheckedUser',
                        type:'post',
                        data:{
                        ...
                        success:function (data) {
                            ...
                            window.location.href="${pageContext.request.contextPath}/searchUser";
                        }
                    })
            }
            else{
