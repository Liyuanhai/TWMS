            ...
            <div class="page-content-area">
                ...
                <div class="row" style="padding-top: 10px;">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                            <form id="searchVersion" method="post" action="/twms/searchVersion">
                                    ...
                                    <table id="sample-table-2"
                                        ...
                                        <c:forEach var="version" items="${versions}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/twms/deleteVersion?id=${version.getId()}" type="button" role="button" class="btn btn-xs btn-danger" onclick="return isDelete()">
                ...
                if (confirm("您确认要删除选中的内容吗？")==false)
                    ...
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            window.location.href="/twms/searchVersion";
                        }
                    })
            }
            else{
