                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form id="editUser${users.getPid()}" class="form-horizontal"  role="form" method="post" action="/twms/editUser">
                ...
                if (confirm("您确认要删除选中的内容吗？")==false)
                    ...
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            window.location.href="/twms/searchUser";
                        }
                    })
            }
            else{
